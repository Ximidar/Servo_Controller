...
void MS5837::init() {
  ...
  for ( uint8_t i = 0 ; i < 8 ; i++ ) {
    ...
    Wire1.requestFrom(MS5837_ADDR,2);
    C[i] = (Wire1.read() << 8) | Wire1.read();
  }
...
void MS5837::read() {
  ...
  Wire1.beginTransmission(MS5837_ADDR);
  Wire1.write(MS5837_CONVERT_D1_8192);
  Wire1.endTransmission();
  ...
  Wire1.requestFrom(MS5837_ADDR,3);
  D1 = 0;
  D1 = Wire1.read();
  D1 = (D1 << 8) | Wire1.read();
  D1 = (D1 << 8) | Wire1.read();
  ...
  Wire1.beginTransmission(MS5837_ADDR);
  Wire1.write(MS5837_CONVERT_D2_8192);
  Wire1.endTransmission();
